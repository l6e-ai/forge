...
class TestExecution:
    ...
    # Execution status
    status: Literal["pending", "running", "passed", "failed", "skipped", "error"] = "pending"
...
class Assertion:
    ...
    assertion_type: Literal[
        "response_contains", "response_matches", "response_equals",
        "tool_called", "tool_not_called", "memory_accessed", 
        "response_time_under", "no_errors", "custom"
    ]
