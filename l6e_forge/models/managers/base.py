...
class IModelManager(Protocol):
    ...
    # Text generation
    async def complete(self, model_id: ModelID, prompt: str, **kwargs) -> CompletionResponse:
        """Generate text completion"""
        ...
    
    async def chat(self, model_id: ModelID, messages: list[Message], **kwargs) -> ChatResponse:
        """Generate chat response"""
        ...
    
    async def stream_complete(self, model_id: ModelID, prompt: str, **kwargs) -> AsyncIterator[str]:
