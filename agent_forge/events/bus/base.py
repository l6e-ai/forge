...
class IEventBus(Protocol):
    ...
    # Subscribing
    async def subscribe(self, event_type: str, handler: IEventHandler) -> SubscriptionID:
        """Subscribe to events of a specific type"""
        ...
    
    async def subscribe_agent(self, agent_id: AgentID, event_type: str, handler: IEventHandler) -> SubscriptionID:
    ...
    async def get_agent_events(self, agent_id: AgentID, limit: int = 100) -> list[Event]:
