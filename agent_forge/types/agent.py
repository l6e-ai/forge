...
class AgentProfile:
    ...
    preferred_tools: Dict[str, float] = field(default_factory=dict)  # tool -> usage_frequency
    
    # Performance characteristics
    response_time_percentiles: Dict[str, float] = field(default_factory=dict)  # p50, p95, p99
...
class AgentTeam:
    ...
    specialization_matrix: Dict[str, List[str]] = field(default_factory=dict)  # agent -> capabilities
    
    # Communication patterns
    communication_rules: Dict[str, List[str]] = field(default_factory=dict)  # agent -> can_communicate_with
    ...
    # Team state
    active_tasks: Dict[str, str] = field(default_factory=dict)  # task_id -> assigned_agent
...
class AgentKnowledgeBase:
    ...
    user_preferences: Dict[str, Dict[str, Any]] = field(default_factory=dict)  # user_id -> preferences
