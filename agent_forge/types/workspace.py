...
class TemplateVariable:
    ...
    # UI hints
    ui_hint: Optional[Literal["text", "textarea", "select", "multiselect", "password"]] = None
...
class TemplateFile:
    ...
    # File conditions
    conditions: Dict[str, Any] = field(default_factory=dict)  # When to include this file
...
class TemplateSpec:
    ...
    # Dependencies
    dependencies: TemplateDependencies = field(default_factory=lambda: TemplateDependencies())
...
class WorkspaceOperation:
    ...
    operation_id: str
    operation_type: Literal["create", "load", "save", "validate", "clean", "backup", "restore"]
