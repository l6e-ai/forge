# agent_forge/types/ecosystem.py
"""Package distribution and ecosystem types for Agent-Forge"""
...
class PackageDependencies:
    ...
    python_packages: dict[str, str] = field(default_factory=dict)  # name -> version_spec
    system_packages: list[str] = field(default_factory=list)
    
    # Agent dependencies (other agents this one depends on)
    agent_dependencies: dict[str, str] = field(default_factory=dict)  # name -> version_spec
    ...
    optional_dependencies: dict[str, dict[str, str]] = field(default_factory=dict)  # group -> {name: version}
...
class AgentPackage:
    ...
    # Installation info
    installation_scripts: dict[str, str] = field(default_factory=dict)  # script_name -> content
...
class PackageVersion:
    ...
    dependencies: PackageDependencies = field(default_factory=lambda: PackageDependencies())
...
class InstallationPlan:
    ...
    # Installation steps
    packages_to_install: list[tuple[str, str]] = field(default_factory=list)  # (name, version)
    packages_to_upgrade: list[tuple[str, str, str]] = field(default_factory=list)  # (name, from_version, to_version)
...
class SecurityPolicy:
    ...
    max_vulnerabilities: dict[str, int] = field(default_factory=dict)  # severity -> max_count
