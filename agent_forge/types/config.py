...
class CapabilitiesConfig:
    ...
    # Capability metadata
    expertise_level: Dict[str, Literal["beginner", "intermediate", "expert"]] = field(default_factory=dict)
...
class PermissionConfig:
    ...
    # Tool permissions
    tool_permissions: Dict[str, List[str]] = field(default_factory=dict)  # agent -> tools
    
    # Resource permissions
    max_memory_per_agent: Dict[str, int] = field(default_factory=dict)  # agent -> MB
    max_cpu_per_agent: Dict[str, float] = field(default_factory=dict)   # agent -> percentage
    
    # Data access permissions
    data_access_levels: Dict[str, Literal["read", "write", "admin"]] = field(default_factory=dict)
    
    # Inter-agent communication
    communication_matrix: Dict[str, List[str]] = field(default_factory=dict)  # agent -> can_talk_to
...
class EnvironmentConfig:
    ...
    optional_env_vars: Dict[str, str] = field(default_factory=dict)  # name -> default_value
    
    # Feature flags
    feature_flags: Dict[str, bool] = field(default_factory=dict)
    
    # External services
    external_services: Dict[str, str] = field(default_factory=dict)  # service -> endpoint
